# una-algprog-lista03
Escolher o tipo de dado correto é importante porque **inteiros e números reais são armazenados de forma diferente no computador**.

* **Inteiro**: guarda apenas números sem parte decimal (ex.: 5, 10, 100).
* **Real**: guarda números com casas decimais (ex.: 7,5 ou 3,14).

Em **sistemas financeiros ou científicos**, muitos cálculos envolvem **valores decimais**. Se o tipo errado for usado:
